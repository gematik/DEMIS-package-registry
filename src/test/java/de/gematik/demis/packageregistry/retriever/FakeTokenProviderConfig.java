...
@TestConfiguration
public class FakeTokenProviderConfig {
  ...
  public GoogleAccessTokenProvider googleAccessTokenProvider() {
    GoogleAccessTokenProvider googleAccessTokenProvider =
        Mockito.mock(GoogleAccessTokenProvider.class);
    String fakeToken = getFakeToken();
    when(googleAccessTokenProvider.getToken()).thenReturn(fakeToken);
