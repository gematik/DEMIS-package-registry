...
COPY --chown=$USERID:$GROUPID target/package-registry.jar /app.jar
...
LABEL de.gematik.vendor="gematik GmbH" \
      ...
      de.gematik.app="Package Registry" \
      de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions/demis/services/package-registry" \
